...
export default function FormulirLamaran({ pelamar, initialForm, isSubmitted }: Props) {
        ...
        <Stack gap={5}>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              {isSubmitted && (
                <Badge tone="mint">✓ Formulir Telah Dikirim Resmi</Badge>
              )}
            </div>
          </div>
                  ...
                  <Field label="No. KTP / SIM" error={errors.no_ktp_sim}>
                    {(id) => (
                      <Input
                        ...
                        onChange={(val) => setData('no_ktp_sim', val)}
              ...
              <Stack gap={5}>
                        ...
                        {data.pendidikan_formal?.map((row: any, idx: number) => (
                          <tr key={idx} className="hover:bg-slate-50/50">
                            ...
                            <td className="p-2">
                              <input
                                type="text"
                                className="w-full px-2 py-1 text-xs rounded border border-slate-200 focus:outline-none focus:border-purple-500"
                ...
                <div className="space-y-4 pt-1">
                  <div>
                    ...
                    <textarea
                      rows={3}
                      className="w-full p-2.5 text-xs rounded-xl border border-slate-200 focus:outline-none focus:border-purple-500 bg-white"
                      ...
                      <tbody className="divide-y divide-slate-100 bg-white">
                        {data.keluarga_inti?.map((row: any, idx: number) => (
                          <tr key={idx}>
                            ...
                            <td className="p-2 text-center">
                              <select
                                className="px-2 py-1 text-xs rounded border border-slate-200 focus:outline-none focus:border-purple-500 bg-white"
              ...
              <Stack gap={5}>
                ...
                <div className="space-y-4">
                  ...
                  <Grid cols={2} gap={4}>
                    ...
                    <Field label="6. Kapan Anda dapat mulai bekerja ?">
                      {(id) => (
                        <Input
                          id={id}
                  ...
                  <div>
                    <label className="text-xs font-bold text-slate-800 block mb-1.5">
                      5. Sebutkan fasilitas lainnya yang Anda harapkan !
                    </label>
                    <textarea
                      rows={2}
                      className="w-full p-2.5 text-xs rounded-xl border border-slate-200 focus:outline-none focus:border-purple-500 bg-white"
                  ...
                  <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200">
                    <label className="text-xs font-bold text-slate-800 uppercase tracking-wider block mb-2">
                      7. Pilihlah pekerjaan yang Anda minati ! (Isi No. Urut 1 - 4)
                    </label>
                    <Grid cols={2} gap={3}>
                      {data.prioritas_pekerjaan?.map((item: any, idx: number) => (
                        <div key={idx} className="flex items-center justify-between p-2.5 rounded-xl bg-white border border-slate-200">
                          <span className="text-xs font-bold text-slate-800">{item.jenis}</span>
                          <input
                            type="text"
                            className="w-16 px-2 py-1 text-xs text-center font-bold rounded border border-slate-300 focus:outline-none focus:border-purple-500"
                            placeholder="Urutan (1-4)"
                            value={item.no_urut || ''}
                            onChange={(e) => updateRowItem('prioritas_pekerjaan', idx, 'no_urut', e.target.value)}
                          />
                        </div>
                      ))}
                    </Grid>
                  ...
                  {/* 8. Bersedia Luar Daerah */}
                  <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200">
                    <label className="text-xs font-bold text-slate-800 uppercase tracking-wider block mb-2">
                      8. Bersediakah Anda ditempatkan di luar daerah ?
                    </label>
                  ...
                  <div>
                    <label className="text-xs font-bold text-slate-800 block mb-1.5">
                      9. Sebutkan type orang yang Anda senangi.
                    </label>
                    <textarea
                      rows={2}
                      className="w-full p-2.5 text-xs rounded-xl border border-slate-200 focus:outline-none focus:border-purple-500 bg-white"
                  ...
                  <div>
                    <label className="text-xs font-bold text-slate-800 block mb-1.5">
                      10. Terhadap hal apa saja Anda sulit mengambil keputusan :
                    </label>
                    <textarea
                      rows={2}
                      className="w-full p-2.5 text-xs rounded-xl border border-slate-200 focus:outline-none focus:border-purple-500 bg-white"
          ...
          <Card>
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
              <div className="text-xs text-slate-500">
                Data draf tersimpan di akun Anda dan dapat diubah sebelum dikirimkan.
              </div>
          ...
          <div className="flex items-start gap-3 p-3.5 rounded-xl bg-purple-50 border border-purple-200 text-purple-900 text-sm">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-purple-800">
                Seluruh data identitas, pendidikan, keluarga, dan pengalaman kerja akan dikirimkan secara resmi ke Tim Rekrutmen PT. Menara Agung.
              </p>
            </div>
          </div>
